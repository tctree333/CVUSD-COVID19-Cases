...
FILENAME_HTML = datetime.date.today().strftime("data/html/%Y-%m-%d.html")
FILENAME_CSV = datetime.date.today().strftime("data/csv/%Y-%m-%d.csv")
...
def main():
    ...
    dfs = pandas.read_html(FILENAME_HTML, skiprows=3, index_col=0, header=(0, 1))
